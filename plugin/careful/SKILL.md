...
description: |
  ...
  Use when touching prod, debugging live systems, or working in shared environment.
allowed-tools:
  - Bash
  - Read
hooks:
...
The hook reads the command from tool input JSON, checks it against the patterns
